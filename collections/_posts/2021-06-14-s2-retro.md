...
Curve (v1) uses a _hybrid of Constant Product and Constant Sum known as the Stableswap_ invariant to significantly reduce price slippage by working as a constant-sum function over a x:y price range, and a constant-product function with amplified invariants at the edges.
